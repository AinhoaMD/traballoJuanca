    ...
    <form @submit.prevent="guardarVehiculo" class="mb-2 mt-1 ms-1">
      ...
      <div class="row g-3 align-items-center mt-1">
        <div class="col-12 col-md-3 d-flex align-items-center">
         ...
         <div class="col-12 col-md-2 d-flex align-items-center">
          ...
          <input type="text" id="matricula"  @blur ="todoTexto('matricula')" v-model="vehiculo.matricula" class="form-control rounded-0 shadow-none border">
        </div>
        ...
        <div class="col-12 col-md-2 d-flex align-items-center ms-2">
          ...
          <input type="text" id="marca" @blur="capitalizarTexto('marca')" v-model="vehiculo.marca" class="form-control rounded-0 shadow-none border" required>
        </div>

        <div class="col-12 col-md-2 d-flex align-items-center">
          <label for="modelo" class="form-label mb-0 me-2 text-nowrap">Modelo:</label>
          <input type="text" id="modelo" @blur="capitalizarTexto('modelo')" v-model="vehiculo.modelo" class="form-control rounded-0 shadow-none border" required>
        </div>
      ...
      <div class="row g-3 align-items-center mt-2">
        ...
        <div class="col-12 col-md-2 d-flex align-items-center">
          ...
          <input type="text" id="potencia" v-model="vehiculo.potencia_cv" class="form-control rounded-0 me-2 shadow-none border text-end" required  >
        </div>     
      </div>
...
<h5 class="text-center bg-primary-subtle py-1"><i class="bi bi-person me-2"></i>Cliente Ubicación</h5>
      ...
      <div class="row g-3 align-items-center mt-3">
        <div class="col-12 col-md-3 d-flex align-items-center">
          ...
          <select id="provincia" @change="filtrarMunicipios" v-model="vehiculo.ubicacion.provincia" class="form-select rounded-0 shadow-none border">
      ...
      <div class="row g-3 align-items-center mt-3">
        <div class="col-12 col-md-4 d-flex align-items-center">
          ...
          <input type="text" id="contacto.nombre" @blur="capitalizarNombreContacto" v-model="vehiculo.contacto.nombre" class="form-control rounded-0 shadow-none border">
        </div>
        <div class="col-12 col-md-2 ms-4 d-flex align-items-center">
          ...
          <input type="tel" id="contacto.telefono" @blur="validarMovil()" v-model="vehiculo.contacto.telefono" class="form-control text-center rounded-0 shadow-none border">
        </div>
        <div class="col-12 col-md-4 d-flex ms-4 align-items-center">
          ...
          <input type="email" id="contacto.email" @blur="validarEmail()" v-model="vehiculo.contacto.email" class="form-control rounded-0 shadow-none border"></input>
        </div>
      </div>
